...
public class QuestionPaper extends Question implements Serializable {
...
//
//		QuestionPaper exm = new QuestionPaper(obj);

		QuestionPaper exm = new QuestionPaper("General Questions!");
